    ...
    <nav className="bg-white shadow-sm py-3 navbar-categories sticky top-[72px] z-40">
      <div className="container-custom">
        <div className="flex justify-between items-center">
              ...
              return (
                <Link
                  ...
                  className={`whitespace-nowrap font-medium py-2 border-b-2 transition-colors duration-300 relative group ${
                    isActive 
                    ? 'text-choco-gold border-choco-gold' 
                ...
                >
                  ...
                  <span className="absolute -top-5 left-1/2 transform -translate-x-1/2 text-xs opacity-0 group-hover:opacity-100 transition-opacity">
                    ✦
                  </span>
                </Link>
              );
          ...
          <div className="lg:hidden w-full">
            <div className="relative">
              <select 
                className="w-full bg-white border border-choco-gold/30 rounded-md py-2 pl-3 pr-8 appearance-none focus:outline-none focus:ring-1 focus:ring-choco-gold"
                onChange={(e) => {
                  if (e.target.value) {
        ...
        <div className="flex justify-center mt-3 pt-3 hidden lg:flex">
          <div className="flex items-center text-xs text-choco-brown/70">
            <span className="mr-2">
